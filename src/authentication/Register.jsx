      ...
      <div className=" custom-container md:flex md:w-4/5">
        ...
        <div className="flex flex-col pt-10">
          ...
          <div className="flex flex-col arsenal-regular justify-center items-center pt-7  ">
            <p className="font-bold text-4xl text-[#5d439e] ">Create Account :</p>
            {/* name */}
            ...
            />
            {/* email */}
            <h1 className="font-bold text-2xl text-[#004b95] pr-[15.5rem]">Email:</h1>
            <input
              placeholder="type your email adress"
              className="rounded-md pl-4 bg-[#658798] bg-opacity-40 py-2 text-xl w-[20rem] placeholder:text-[#004b95] placeholder:text-opacity-55  "
            />
            {/* password */}
            <h1 className="font-bold text-2xl  text-[#004b95] pr-[13rem]">Password:</h1>
            <input
              type="password"
          ...
          <div className="pt-5 flex items-center justify-center">
            <button className=" text-[#fef6ee] w-[20rem] rounded-md p-2 bg-[#5d439e] hover:bg-[#9762c9]  ">
              Create new account
            </button>
          </div>
          {/* continue with */}
